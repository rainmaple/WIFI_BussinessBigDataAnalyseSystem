...
public class ShenfangHandler {
	...
	public static String GetRate(){
		...
		return String.valueOf(1.0*num[3]/sun*100);
	}
	public static double[] GetHisRate() {
		...
		for(int i=0;i<=3;i++){
			rate[i] = Double.valueOf(DaoUtil.getValueByFamily(Zhudian_TABLE[2],"1",Family[i],qua)[0]);
		}
		return rate;
	}
	...
	public static String[] GetHourNum(int length){
		...
		String[] HisArr=DaoUtil.getValueByFamily(Zhudian_TABLE[2],"1","hour",qua);
		for(int i=0;i<=length-1;i++){
			if(HisArr[i]!=null){
	...
	public static String[] GetDayNum(int length){
		String Num[]=new String[length];
		String[] qua={"6","5","4","3","2","1"};
		String[] HisArr=DaoUtil.getValueByFamily(Zhudian_TABLE[2],"1","day",qua);
		for(int i=0;i<=length-1;i++){
			if(HisArr[i]!=null){
	...
	public static String[] GetWeekNum(int length){
		String Num[]=new String[length];
		String[] qua={"4","3","2","1"};
		String[] HisArr=DaoUtil.getValueByFamily(Zhudian_TABLE[2],"1","week",qua);
		for(int i=0;i<=length-1;i++){
			if(HisArr[i]!=null){
	...
	public static String[] GetMonthNum(int length){
		String Num[]=new String[length];
		String[] qua={"4","3","2","1"};
		String[] HisArr=DaoUtil.getValueByFamily(Zhudian_TABLE[2],"1","month",qua);
		for(int i=0;i<=length-1;i++){
			if(HisArr[i]!=null){
