...
public class PassFlowChartServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String method_name="Get"+req.getParameter("type")+"PassFlow";
		String[] FlowArr=null;
		try {
			System.out.println(req.getParameter("type")+" "+ method_name);
			Method m=PassFlowHandler.class.getMethod(method_name, int.class);
